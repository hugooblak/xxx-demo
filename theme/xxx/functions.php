 ...
 * Lead capture lives in the ". Leads" plugin, so leads survive a theme change.
 *
 * @package .
 */
 ...
 * Patterns read these through xx_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'xxx' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'xxx' ) ) );

		register_block_pattern_category( 'xxx-sections', array( 'label' => __( '. sections', 'xxx' ) ) );
		register_block_pattern_category( 'xxx-pages', array( 'label' => __( '. page layouts', 'xxx' ) ) );
	}
);
