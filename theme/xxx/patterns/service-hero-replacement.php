 ...
 * Slug: xxx/service-hero-replacement
...
?>
<!-- wp:group {"align":"full","className":"xx-sec-hero","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"backgroundColor":"sand","layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group alignfull xx-sec-hero has-sand-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|60"}}}} -->
...
<div class="wp-block-button xx-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/?service=replacement' ); ?>">Boka kostnadsfri besiktning</a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline xx-track-call"} -->
<div class="wp-block-button is-style-outline xx-track-call"><a class="wp-block-button__link wp-element-button" href="tel:+15550100142">Ring Anders · 070-123 45 67</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"className":"xx-stars","fontSize":"small"} -->
<p class="xx-stars has-small-font-size"><strong>4,9 av 5</strong> från 158 omdömen <span class="xx-sample">(platshållare)</span></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
