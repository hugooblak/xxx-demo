...
<div class="wp-block-button xx-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/?service=storm' ); ?>">Boka kostnadsfri besiktning</a></div>
<!-- /wp:button -->
